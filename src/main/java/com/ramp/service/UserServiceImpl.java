...
public class UserServiceImpl implements UserService {
	    ...
	    public StatusResponse<UserResponse> registerUser(UserReq req) {
	        ...
	        return new StatusResponse<UserResponse>(StatusCode.CREATED, responseDto, "User registered successfully");
	    }

	    @Override
	    public StatusResponse<LoginResponse> login(String username, String password, JwtUtil jwtUtil) {
	        ...
	        return new StatusResponse<>(StatusCode.SUCCESS, loginResponse, "Login successful");
	    }
	    ...
	    public StatusResponse<UserResponse> registerCMS(CMSRegistrationReq req) {
	        ...
	        // Get or create CONTENT_MANAGER role
	        ...
	        return new StatusResponse<>(StatusCode.CREATED, responseDto, "CMS user registered successfully");
	    }
	    ...
	    public StatusResponse<UserResponse> registerAdmin(AdminRegistrationReq req) {
	        ...
	        return new StatusResponse<>(StatusCode.CREATED, responseDto, "Admin user registered successfully");
	    }
	    ...
	    public StatusResponse<List<UserResponse>> getAllUsers() {
	        ...
	        return new StatusResponse<>(StatusCode.SUCCESS, responseList, "Users retrieved successfully");
	    }
	    ...
	    public StatusResponse<List<UserResponse>> getUsersByRole(String roleName) {
	        try {
	            ...
	            return new StatusResponse<>(StatusCode.BAD_REQUEST, null, "Invalid role name");
	        }
	    }
